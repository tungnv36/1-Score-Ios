...
var loanRequestData:[LoanRequestEntity] = [
    ...
    LoanRequestEntity(icon: #imageLiteral(resourceName: "ios_medium_loan"), loanName: "Medium loan", loanMoney: "10.000.000 VNĐ", cost: "150.000 VNĐ", interest: "50.000 VNĐ", progress: 8, maxProgress: 10, condition: "Level 10", isShow: true),
